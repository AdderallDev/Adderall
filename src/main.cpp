...
const string strMessageMagic = "Adderall Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Adderall", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "http://www.theonion.com/articles/antidepressant-cant-believe-its-expected-to-fix-th,37309/";
        CTransaction txNew;
        txNew.nTime = 1414667242;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1414667242;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 3523851;
		if(fTestNet)
        {
            block.nNonce   = 3523851;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x563e153d8c6a6c4f7b84ead852b5c8687afa72f3b761a975acdf16d5ee2ca534"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xf1, 0xf0, 0xf2, 0xf3 };
